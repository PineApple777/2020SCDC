...
def predict_cst():
	...
	model = tf.keras.models.Sequential([
		tf.keras.layers.Conv1D(filters=64, kernel_size=3, activation='relu', input_shape=(226, 1)),
	...
	_, evaluate = model.evaluate(test_feats_tensor, test_labels_tensor, verbose=0)
